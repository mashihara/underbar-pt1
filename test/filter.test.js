...
describe('filter()', () => {
  ...
  it('always true', () => {
    ...
    const abilityScores = _.filter(characterAttributes, (value) => true);
    expect(abilityScores).toEqual(['Thokul Mongothsbeard', 'Lord Thokul Mongothsbeard the Arcane', 'human', 'druid', 4, 7, 10, 16, 5, 4]);
  });
